...
public class ItemGridAdapter extends RecyclerView.Adapter<ItemGridAdapter.ViewHolder> implements Filterable {
    ...
    public ItemGridAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_shop_item_grid, parent, false);
    ...
    private void setAnimation(View viewToAnimate, int position) {
        ...
        if (position > lastPosition) {
            Animation animation = AnimationUtils.loadAnimation(ctx, R.anim.app_shop_slide_in_bottom);
