...
public class Constant {
    ...
    public static List<String> getHomeCatgeory(Context ctx) {
        ...
        String name_arr[] = ctx.getResources().getStringArray(R.array.app_news_home_category);
    ...
    public static List<Channel> getChannelData(Context ctx) {
        ...
        String name_arr[] = ctx.getResources().getStringArray(R.array.app_news_channel_name);
        String color_arr[] = ctx.getResources().getStringArray(R.array.app_news_channel_color);
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.app_news_channel_icon);
        for (int i = 0; i < name_arr.length; i++) {
    ...
    public static List<News> getNewsPolitics(Context ctx) {
        ...
        String title_arr[] = ctx.getResources().getStringArray(R.array.app_news_news_title_p);
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.app_news_news_img_p);
        String content = ctx.getString(R.string.app_news_very_long_lorem_ipsum);
    ...
    public static List<News> getNewsEntertainment(Context ctx) {
        List<News> items = new ArrayList<>();
        String title_arr[] = ctx.getResources().getStringArray(R.array.app_news_news_title_e);
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.app_news_news_img_e);
        String content = ctx.getString(R.string.app_news_very_long_lorem_ipsum);
        for (int i = 0; i < title_arr.length; i++) {
    ...
    public static List<News> getNewsScience(Context ctx) {
        List<News> items = new ArrayList<>();
        String title_arr[] = ctx.getResources().getStringArray(R.array.app_news_news_title_sc);
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.app_news_news_img_sc);
        String content = ctx.getString(R.string.app_news_very_long_lorem_ipsum);
        for (int i = 0; i < title_arr.length; i++) {
    ...
    public static List<News> getNewsSport(Context ctx) {
        List<News> items = new ArrayList<>();
        String title_arr[] = ctx.getResources().getStringArray(R.array.app_news_news_title_sp);
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.app_news_news_img_sp);
        String content = ctx.getString(R.string.app_news_very_long_lorem_ipsum);
        for (int i = 0; i < title_arr.length; i++) {
    ...
    public static List<News> getNewsBusiness(Context ctx) {
        List<News> items = new ArrayList<>();
        String title_arr[] = ctx.getResources().getStringArray(R.array.app_news_news_title_b);
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.app_news_news_img_b);
        String content = ctx.getString(R.string.app_news_very_long_lorem_ipsum);
        for (int i = 0; i < title_arr.length; i++) {
    ...
    public static List<News> getNewsTechnology(Context ctx) {
        List<News> items = new ArrayList<>();
        String title_arr[] = ctx.getResources().getStringArray(R.array.app_news_news_title_t);
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.app_news_news_img_t);
        String content = ctx.getString(R.string.app_news_very_long_lorem_ipsum);
        for (int i = 0; i < title_arr.length; i++) {
    ...
    public static String getRandomDate(Context ctx) {
        String date_arr[] = ctx.getResources().getStringArray(R.array.app_news_general_date);
