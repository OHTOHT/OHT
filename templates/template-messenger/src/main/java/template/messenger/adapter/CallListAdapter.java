...
import template.messenger.ActivityCalling;
import template.messenger.ActivityVideo;
...
public class CallListAdapter extends RecyclerView.Adapter<CallListAdapter.ViewHolder> implements Filterable {
    ...
    public CallListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_messenger_row_call_friends, parent, false);
