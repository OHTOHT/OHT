...
public class GroupDetailsListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
        	...
        	convertView			= LayoutInflater.from(ctx).inflate(R.layout.app_messenger_row_group_details, parent, false);
        ...
        if(g.isFromMe()){
			...
			holder.lyt_thread.setCardBackgroundColor(ctx.getResources().getColor(R.color.app_messenger_colorPrimary));
			...
			holder.lyt_thread.setCardBackgroundColor(ctx.getResources().getColor(R.color.app_messenger_grey_soft));
			holder.time.setTextColor(ctx.getResources().getColor(R.color.app_messenger_grey_dark));
			holder.message.setTextColor(ctx.getResources().getColor(R.color.app_messenger_grey_dark));
        }
        return convertView;
	}
