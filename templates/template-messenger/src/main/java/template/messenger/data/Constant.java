...
public class Constant {
    ...
    public static List<Friend> getFriendsData(Context ctx)  {
        ...
        String s_arr[] = ctx.getResources().getStringArray(R.array.app_messenger_people_names);
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.app_messenger_people_photos);
    ...
    public static List<Chat> getChatsData(Context ctx)  {
        ...
        String s_arr[] = ctx.getResources().getStringArray(R.array.app_messenger_people_names);
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.app_messenger_people_photos);
        String s_cht[] = ctx.getResources().getStringArray(R.array.app_messenger_chat_snippet);
        String s_date[] = ctx.getResources().getStringArray(R.array.app_messenger_chat_date);
        for (int i = 0; i < 10; i++) {
    ...
    public static List<Group> getGroupData(Context ctx)  {
        ...
        String s_name[] = ctx.getResources().getStringArray(R.array.app_messenger_groups_name);
        String s_date[] = ctx.getResources().getStringArray(R.array.app_messenger_groups_date);
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.app_messenger_groups_photos);
    ...
    public static List<ChatsDetails> getChatDetailsData(Context ctx, Friend friend)  {
        ...
        String s_date[] = ctx.getResources().getStringArray(R.array.app_messenger_chat_details_date);
        String s_content[] = ctx.getResources().getStringArray(R.array.app_messenger_chat_details_content);
    ...
    public static List<GroupDetails> getGroupDetailsData(Context ctx)  {
        ...
        String s_date[] = ctx.getResources().getStringArray(R.array.app_messenger_group_details_date);
        String s_content[] = ctx.getResources().getStringArray(R.array.app_messenger_group_details_content);
    ...
    public static List<Integer> getRandomPhotos(Context ctx)  {
        ...
        TypedArray photo = ctx.getResources().obtainTypedArray(R.array.app_messenger_feed_photos);
