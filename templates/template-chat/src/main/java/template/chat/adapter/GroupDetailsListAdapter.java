...
public class GroupDetailsListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
        	...
        	convertView			= LayoutInflater.from(ctx).inflate(R.layout.app_chat_row_group_details, parent, false);
        ...
        if(g.isFromMe()){
			...
			holder.lyt_thread.setCardBackgroundColor(ctx.getResources().getColor(R.color.app_chat_me_chat_bg));
        }else{
			...
			//holder.image_status.setImageResource(android.R.color.app_chat_transparent);
        }
        return convertView;
	}
