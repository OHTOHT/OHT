...
import template.chat.adapter.GroupDetailsListAdapter;
...
public class ActivityGroupDetails extends AppCompatActivity {
    public static String KEY_GROUP = "template.chat.GROUP";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_chat_activity_group_details);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.app_chat_menu_group_details, menu);
        return true;
    }
