...
public class FragmentDialogCity extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        root_view = inflater.inflate(R.layout.app_travel_fragment_dialog_city, container, false);
        initToolbar();
        initComponent();
        return root_view;
    }
    ...
    private void initComponent() {
        ...
        final CityListAdapter mAdapter = new CityListAdapter(getActivity(), GlobalVariable.getInstance(getContext().getApplicationContext()).getCities());
