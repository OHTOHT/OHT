...
public class Tools {
    ...
    public static void systemBarLollipop(Activity act) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.setStatusBarColor(act.getResources().getColor(R.color.app_music_colorPrimaryDark));
        }
    }
    ...
    public static int getGridSpanCount(Activity activity) {
        ...
        float cellWidth = activity.getResources().getDimension(R.dimen.app_music_recycler_item_size);
