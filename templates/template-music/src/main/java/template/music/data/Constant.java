...
public class Constant {
    ...
    public static List<MusicSong> getMusicSong(Context ctx) {
        ...
        String song_name[] = ctx.getResources().getStringArray(R.array.app_music_song_name);
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.app_music_album_cover);
        String album_name[] = ctx.getResources().getStringArray(R.array.app_music_album_name);
        int album_idx = 0;
    ...
    public static List<Artist> getArtist(Context ctx) {
        ...
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.app_music_artist_photo);
        String name[] = ctx.getResources().getStringArray(R.array.app_music_artist_name);
        String brief[] = ctx.getResources().getStringArray(R.array.app_music_artist_brief);
        for (int i = 0; i < drw_arr.length(); i++) {
    ...
    public static List<Playlist> getPlaylist(Context ctx) {
        ...
        String name[] = ctx.getResources().getStringArray(R.array.app_music_playlist_name);
