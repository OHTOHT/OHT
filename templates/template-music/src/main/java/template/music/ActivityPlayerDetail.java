...
public class ActivityPlayerDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_music_activity_player_detail);
    ...
    private boolean toggleButtonColor(ImageView bt) {
        ...
        if (selected != null) { // selected
            bt.setColorFilter(getResources().getColor(R.color.app_music_grey_hard), PorterDuff.Mode.SRC_ATOP);
            bt.setTag(bt.getId(), null);
            return false;
        } else {
            bt.setTag(bt.getId(), "selected");
            bt.setColorFilter(getResources().getColor(R.color.app_music_colorAccent), PorterDuff.Mode.SRC_ATOP);
            return true;
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.app_music_menu_activity_player_detail, menu);
