...
public class MessageDetailsListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
        	...
        	convertView			= LayoutInflater.from(ctx).inflate(R.layout.app_social_row_message_details, parent, false);
        ...
        if(msg.isFromMe()){
			...
			holder.lyt_thread.setCardBackgroundColor(ctx.getResources().getColor(R.color.app_social_me_chat_bg));
        }else{
			...
			//holder.image_status.setImageResource(android.R.color.app_social_transparent);
        }
        return convertView;
	}
