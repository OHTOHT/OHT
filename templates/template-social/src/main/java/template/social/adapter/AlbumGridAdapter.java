...
import template.social.model.Friend_photos;
...
public class AlbumGridAdapter extends RecyclerView.Adapter<AlbumGridAdapter.ViewHolder> implements Filterable {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_social_item_grid_friend_photo, parent, false);
    ...
    private void setAnimation(View viewToAnimate, int position) {
        ...
        if (position > lastPosition) {
            Animation animation = AnimationUtils.loadAnimation(ctx, R.anim.app_social_slide_in_bottom);
