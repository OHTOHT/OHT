...
public class ActivityLogin extends AppCompatActivity {
    ...
    private boolean validateName() {
        if (input_username.getText().toString().trim().isEmpty()) {
            //inputLayoutName.setError(getString(R.string.app_insta_err_msg_name));
            Snackbar.make(parent_view, getString(R.string.app_insta_err_msg_name), Snackbar.LENGTH_SHORT).show();
    ...
    private boolean validateEmail() {
        ...
        if (password.isEmpty()) {
            Snackbar.make(parent_view, getString(R.string.app_insta_err_msg_password), Snackbar.LENGTH_SHORT).show();
