...
public class InboxFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.app_mailbox_fragment_inbox, null);
        ...
        mAdapter = new MailListAdapter(MailListAdapter.INBOX_MODE ,getActivity(), GlobalVariable.getInbox());
    ...
    public void onResume() {
        mAdapter.setItems(GlobalVariable.getInbox());
        super.onResume();
    }
