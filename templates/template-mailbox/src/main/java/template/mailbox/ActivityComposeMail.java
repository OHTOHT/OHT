...
public class ActivityComposeMail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CustomerAdapter adapter = new CustomerAdapter(this, R.layout.app_mailbox_row_people, items);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_send) {
            ...
            if(address_receiver==null){
                ...
                receiver = new People(GlobalVariable.getPeoples().size(), null, address_receiver, R.drawable.app_mailbox_unknown_avatar);
            }
            ...
            People me = new People(0, this.getString(R.string.app_mailbox_me_name), this.getString(R.string.app_mailbox_me_mail), R.drawable.app_mailbox_profile);


            GlobalVariable.addOutbox(
                    new Mail(
                            Long.parseLong("11" + GlobalVariable.getOutbox().size()),
                            "now",
                            me,
                            receiver,
