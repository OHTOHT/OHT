...
public class Tools {
    ...
    public static void systemBarLolipop(Activity act) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.setStatusBarColor(act.getResources().getColor(R.color.app_taxi_colorPrimaryDark));
        }
    }
    ...
    private static void displayMarker(Activity act, GoogleMap googleMap, CarAround c) {
        ...
        marker.setImageResource(R.drawable.app_taxi_ic_car_pin);
    ...
    public static String getGoogleMapApiKey(Context ctx) {
        // Receiving side
        String base64 = ctx.getResources().getString(R.string.app_taxi_google_maps_key);
