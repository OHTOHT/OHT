...
public class BookingListAdapter extends RecyclerView.Adapter<BookingListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_taxi_item_booking, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if (b.status.equals("ON GOING")) {
            holder.status.setBackgroundDrawable(ctx.getResources().getDrawable(R.drawable.app_taxi_shape_rectangle_ongoing));
        } else if (b.status.equals("FINISHED")) {
            holder.status.setBackgroundDrawable(ctx.getResources().getDrawable(R.drawable.app_taxi_shape_rectangle_finished));
        } else if (b.status.equals("CANCELED")) {
            holder.status.setBackgroundDrawable(ctx.getResources().getDrawable(R.drawable.app_taxi_shape_rectangle_canceled));
        }
