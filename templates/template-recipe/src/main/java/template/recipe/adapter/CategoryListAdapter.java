package template.recipe.adapter;
...
public class CategoryListAdapter extends RecyclerView.Adapter<CategoryListAdapter.ViewHolder> implements Filterable {
    ...
    public CategoryListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_recipe_item_category, parent, false);
    ...
    private void setAnimation(View viewToAnimate, int position) {
        ...
        if (position > lastPosition) {
            Animation animation = AnimationUtils.loadAnimation(ctx, R.anim.app_recipe_slide_in_bottom);
