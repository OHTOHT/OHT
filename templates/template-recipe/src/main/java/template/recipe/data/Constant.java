...
public class Constant {
    ...
    public static List<Category> getItemCategory(Context ctx) {
        ...
        TypedArray img_cat = ctx.getResources().obtainTypedArray(R.array.app_recipe_category_photos);
        TypedArray ic_cat = ctx.getResources().obtainTypedArray(R.array.app_recipe_category_icon);
        String[] name_cat = ctx.getResources().getStringArray(R.array.app_recipe_category_names);
    ...
    public static List<Recipe> getItemAppertize(Context ctx) {
        ...
        TypedArray img_ = ctx.getResources().obtainTypedArray(R.array.app_recipe_photos_appetizers);
        String[] name_ = ctx.getResources().getStringArray(R.array.app_recipe_appetizers_names);
        String[] duration_ = ctx.getResources().getStringArray(R.array.app_recipe_appetizers_duration);
    ...
    public static List<Recipe> getItemMainDish(Context ctx) {
        List<Recipe> items = new ArrayList<>();
        TypedArray img_ = ctx.getResources().obtainTypedArray(R.array.app_recipe_photos_main_dish);
        String[] name_ = ctx.getResources().getStringArray(R.array.app_recipe_main_dish_names);
        String[] duration_ = ctx.getResources().getStringArray(R.array.app_recipe_main_dish_duration);
    ...
    public static List<Recipe> getItemSalads(Context ctx) {
        List<Recipe> items = new ArrayList<>();
        TypedArray img_ = ctx.getResources().obtainTypedArray(R.array.app_recipe_photos_salads);
        String[] name_ = ctx.getResources().getStringArray(R.array.app_recipe_salads_names);
        String[] duration_ = ctx.getResources().getStringArray(R.array.app_recipe_salads_duration);
    ...
    public static List<Recipe> getItemDrinks(Context ctx) {
        List<Recipe> items = new ArrayList<>();
        TypedArray img_ = ctx.getResources().obtainTypedArray(R.array.app_recipe_photos_drinks);
        String[] name_ = ctx.getResources().getStringArray(R.array.app_recipe_drinks_names);
        String[] duration_ = ctx.getResources().getStringArray(R.array.app_recipe_drinks_duration);
    ...
    public static List<Recipe> getItemSideDish(Context ctx) {
        List<Recipe> items = new ArrayList<>();
        TypedArray img_ = ctx.getResources().obtainTypedArray(R.array.app_recipe_photos_side_dish);
        String[] name_ = ctx.getResources().getStringArray(R.array.app_recipe_side_dish_names);
        String[] duration_ = ctx.getResources().getStringArray(R.array.app_recipe_side_dish_duration);
    ...
    public static List<Recipe> getItemDessert(Context ctx) {
        List<Recipe> items = new ArrayList<>();
        TypedArray img_ = ctx.getResources().obtainTypedArray(R.array.app_recipe_photos_dessert);
        String[] name_ = ctx.getResources().getStringArray(R.array.app_recipe_dessert_names);
        String[] duration_ = ctx.getResources().getStringArray(R.array.app_recipe_dessert_duration);
